...
public class AdministradorGeneralEntity implements Serializable {
    ...
    public AdministradorGeneralEntity(Long id, String correo, String telefono, String primerNombre, String segundoNombre, String primerApellido, String segundoApellido) {
        this.id = id;
        this.correo = correo;
